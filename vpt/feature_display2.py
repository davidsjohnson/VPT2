...
def save_data(X_lh, y_lh, vis_lhs, X_rh, y_rh, vis_rhs, filenames, M, radius, feature_type, data_type, participants):
    ...
    np.savez_compressed(data_path + data_type + "_data.npz", X_lh=X_lh, y_lh=y_lh, vis_lhs=vis_lhs,
...
ims = [axes[i][j].imshow(np.zeros((120,90)), animated=True, vmin=0, vmax=850)  if i == 0
